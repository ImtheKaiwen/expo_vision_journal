...
const tr = {
  ...
  paywallVisionTitle: 'Sınırsız Vizyon',
  paywallVisionDesc: 'Hedeflerin için sınırları kaldır, istediğin kadar vizyon oluştur.',
  paywallSecurityTitle: 'Tam Gizlilik',
  paywallSecurityDesc: 'Günlüklerini kilit altında tut, sadece senin gözlerin görsün.',
  paywallAiTitle: 'Yapay Zeka Asistanı',
  paywallAiDesc: 'Günlüklerinden analizler çıkar, sana özel tavsiyeler al.',
  restore: 'Geri Yükle',
...
const en = {
  ...
  paywallVisionTitle: 'Unlimited Visions',
  paywallVisionDesc: 'Remove limits for your goals, create as many visions as you want.',
  ...
  paywallAiDesc: 'Get insights from your journals, receive personalized advice.',
  restore: 'Restore',
