...
const tr = {
  ...
  startVisionPro: "Vision Premium'u Başlat",
  ...
  monthlyPrice: 'Aylık {{price}}',
  yearlyPrice: 'Yıllık {{price}}',
  sixMonthPrice: '6 Aylık {{price}}',
  ...
  aiLimitReachedTitle: 'Günlük Sınır Aşıldı',
  aiLimitReachedMsg: 'Görsel analiz için günlük 50 olan limitinize ulaştınız. Yarın tekrar deneyebilirsiniz.',
  weightUpdateTitle: 'Haftalık Kilo Güncelleme',
  weightUpdateMsg: 'Yeni bir haftaya başlarken kilonu güncelleyelim. Şu an kaç kilosun?',
  updateWeight: 'Kiloyu Güncelle',
...
const en = {
  ...
  back: 'Back',
  todoPlaceholder: 'What will you do today?',
  addTodo: 'Add Task',
  noTodo: 'No tasks planned for today.',
  todoAIPlaceholder: 'Plan with AI (Coming Soon)',
  todoAIBtn: 'Plan with Artificial Intelligence',
  ...
  rolloverTitle: 'Remaining from Yesterday',
  rolloverMsg: 'You have {{count}} uncompleted tasks from yesterday. Would you like to move them to today?',
  rolloverBtn: 'Move to Today',
  rolloverSkip: 'Let them stay',
  todoBulkHint: 'Each line is saved as a separate task.',
  ...
  startVisionPro: 'Start Vision Premium',
  cancelAnytime: 'Cancel anytime. Manage your subscriptions from App Store settings.',
  purchaseError: 'Purchase could not be completed or was cancelled.',
  restoreSuccess: 'Your subscription was successfully restored.',
  ...
  sixMonthPrice: '{{price}} / 6 months',
  videoSaveError: 'Video could not be saved.',
  ...
  aiLimitReachedTitle: 'Daily Limit Reached',
  aiLimitReachedMsg: 'You have reached your daily limit of 50 visual analyses. You can try again tomorrow.',
  weightUpdateTitle: 'Weekly Weight Update',
  weightUpdateMsg: 'Let\'s update your weight as we start a new week. What is your current weight?',
